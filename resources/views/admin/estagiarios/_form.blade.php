...
<label>Valor Pelo Estagio</label>
</div>
...
<div class="input-field">
        <p>
            <input type="checkbox" id="publicar" value="true" name="publicado" {{isset($registro->publicado) && $registro->publicado == 'sim' ? 'checked' : ''}}>
            <label for="publicar">Disponivel?</label>
        </p>
        <br>
    </div>